  ...
  return (
    ...
    >
      ...
      <ul className="font-questrial text-lg text-primary">
        ...
        <li className="mb-4">
          We charge a small COD fee of INR 50 on each order for Cash On Delivery
          facility.
        </li>
        <li className="mb-4">
        ...
        <li className="mb-4">
          The delivery service has a ETA of 2-7 days from the date of dispatch.
        </li>
        <li className="mb-4">
      ...
      <ul className="font-questrial text-lg text-primary w-full">
        <li className="mb-4">
          International shipping rates are based on actual costs and calculated
          on order size.
        </li>
        <li className="mb-4">
