...
export async function generateMetadata() {
  return {
    ...
    openGraph: {
      ...
      description:
        'Dorje Teas sells only whole leaf Darjeeling Tea which has been plucked, packed and dispatched directly from certified Organic Selim Hill Tea Estate. We prepare the tea in small batches. It is our effort to revive and consolidate the beauty and romance of Darjeeling.',
      url: `https://dorjeteas.com/policies/privacy-policy`,
      siteName: 'Dorje Teas',
      images: [
        {
    ...
    <div className="w-full h-full bg-white">
      ...
      >
        ...
        <div className="font-questrial text-lg text-primary">
          ...
          information (like zip code, age, or <br />
        ...
        <div className="font-questrial text-lg text-primary">
          ...
          to a given user. We place both permanent and temporary cookies in your
          computer’s hard drive. The cookies do not contain any of your
        ...
        <div className="font-questrial text-lg text-primary">
          ...
          orders, or other legal process. We may disclose personal information
          to law enforcement offices, third party rights owners, or others in
          the good faith belief that such disclosure is reasonably necessary to:
