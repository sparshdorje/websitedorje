...
const page = () => {
  return (
    ...
    >
      ...
      <div className="font-questrial text-lg text-primary">
        By mere use of the Website, you specifically consent to our use and
      ...
      <div className="font-questrial text-lg text-primary">
        ...
        a particular service or feature on the Website. We may automatically
        track certain information about you based upon your behaviour on our
        Website. We use this information to do internal research on our users’
        ...
        aggregated basis. This information may include the URL that you just
        came from (whether this URL is on our Website or not), which URL you
        next go to (whether this URL is on our Website or not), your computer
      ...
      <div className="font-questrial text-lg text-primary">
        If you transact with us, we collect some additional information, such as
      ...
      <div className="font-questrial text-lg text-primary">
        ...
        other message areas or leave feedback, we will collect that information
      ...
      <div className="font-questrial text-lg text-primary">
        We use personal information to provide the services you request. To the
      ...
      <div className="font-questrial text-lg text-primary">
        ...
        we collect and analyse demographic and profile data about our users’
      ...
      <div className="font-questrial text-lg text-primary">
        We will occasionally ask you to complete optional online surveys. These
        surveys may ask you for contact information and demographic information
        (like zip code, age, or <br />
        income level). We use this data to tailor your experience at our
      ...
      <div className="font-questrial text-lg text-primary font-semibold w-full">
        Cookies
      </div>

      <div className="font-questrial text-lg text-primary">
        A “cookie” is a small piece of information stored by a web server on a
        web browser so it can be later read back from that browser. Cookies are
        useful for enabling the browser to remember information specific to a
        given user. We place both permanent and temporary cookies in your
        computer’s hard drive. The cookies do not contain any of your personally
      ...
      <div className="font-questrial text-lg text-primary">
        ...
        services that you request where such services are provided by more than
        one corporate entity. Those entities and affiliates may not market to
        you as a result of such sharing unless you explicitly opt-in.
      </div>
      ...
      <div className="font-questrial text-lg text-primary">
        ...
        respond to subpoenas, court <br />
        orders, or other legal process. We may disclose personal information to
        law enforcement offices, third party rights owners, or others in the
      ...
      <div className="font-questrial text-lg text-primary">
        ...
        adhere to strict security guidelines, protecting it against unauthorized
        access.
      </div>
      ...
      <div className="font-questrial text-lg text-primary">
        ...
        non-essential (promotional, marketing-related) communications from us on
        behalf of our partners, and from us in general, after setting up an
        account.
      </div>
      ...
      <div className="w-full font-questrial text-lg text-primary">
        For further information, please contact us at admin@dorjeteas.com.
      </div>
    </MaxWidthWrapper>
  );
};
