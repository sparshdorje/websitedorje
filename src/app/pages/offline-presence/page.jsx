  ...
  return (
    ...
    >
      ...
      <div className="font-questrial text-lg text-primary">
        To purchase our teas physically, you can visit the following locations.
        To become a reseller, you can write to us at team@dorjeteas.com.
      </div>

      <div className="flex flex-col items-center gap-4 p-4 rounded-lg bg-white w-full shadow-md">
      ...
      <div className="flex flex-col items-center gap-4 p-4 rounded-lg bg-white w-full shadow-md">
        <div className="font-questrial font-medium text-primary">HYDERABAD</div>
        <div className="font-fraunces font-semibold text-xl lg:text-2xl text-primary">
      ...
      <div className="flex flex-col items-center gap-4 p-4 rounded-lg bg-white w-full shadow-md">
        <div className="font-questrial font-medium text-primary">KURSEONG</div>
        <div className="font-fraunces font-semibold text-xl lg:text-2xl text-primary">
          33DREAM CAFE
        </div>
      </div>
      ...
      <div className="flex flex-col items-center gap-4 p-4 rounded-lg bg-white w-full shadow-md">
        <div className="font-questrial font-medium text-primary">BENGALURU</div>
        <div className="font-fraunces font-semibold text-xl lg:text-2xl text-primary">
          Humble Bean Cafe
        </div>
      </div>
